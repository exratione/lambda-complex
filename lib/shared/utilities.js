/**
 * @fileOverview Utilities shared between deploy code and Lamdba functions.
 *
...
/**
 * Give the queue name from configuration, get the full queue URL.
 *
 * @param {String} name Name of a component.
 * @param {Object} arnMap The ARN map for a deployed application.
...
exports.getQueueUrl = function (name, arnMap) {
  var arn = exports.getQueueArn(name, arnMap);
...
/**
 * Obtain the ARN for a Lamda function.
 *
 * @param {String} name Name of a component.
 * @param {Object} arnMap The ARN map for a deployed application.
 * @return {String} The queue ARN.
